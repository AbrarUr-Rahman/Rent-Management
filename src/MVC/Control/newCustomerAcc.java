 ...
 * @author Niloy
 */
public class newCustomerAcc extends javax.swing.JFrame {

    /**
     * Creates new form newFacAcc
     */
    public String cN, cE, cA, cC, cU, cP;
    public newCustomerAcc() {
        initComponents();
    ...
    private void initComponents() {
        ...
        createLabel.setText("Create Customer Account");
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(emailField, javax.swing.GroupLayout.DEFAULT_SIZE, 339, Short.MAX_VALUE)
    ...
    private void loginButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginButton1ActionPerformed
        // TODO add your handling code here:
        cN=nameField.getText();
        cE=emailField.getText();
        cU=userField.getText();
        cC=contactField.getText();
        cA=addressField.getText();
        cP=passField.getText();
        while(true)
        {
            try 
            {
                ...
                if(cr.userType(cU)=="customer" || cr.userType(cU)=="owner")
                {
                    noteLabel.setText("Note: Account of this username already exists!");
                    break;
                }
                cr.cCreate(cN,cE, cC, cA, cU, cP);
                login a=new login();
                a.setVisible(true);
                ...
                Logger.getLogger(newCustomerAcc.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(newCustomerAcc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
